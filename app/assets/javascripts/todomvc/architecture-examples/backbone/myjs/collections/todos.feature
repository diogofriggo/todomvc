Feature: Todo.Collection
  ...
  Scenario: Constructor
    Given I want to declare my own Collection
    And The fact that Backbone's concept of Collection maps to Ext's concept of Store
    Then Extend Backbone.Collection
    And Assign the result to an app's variable
  ...
  Scenario: LocalStorage
    ...
    Then Create new Store (named ?) (defined by Backbone) passing in a name
